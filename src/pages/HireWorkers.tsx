          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Browse people who are <span className="font-semibold text-blue-600">looking for jobs</span> in Gweru
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">For Employers</h3>
              <p className="text-sm text-blue-700 mt-1">
                These are <strong>job seekers</strong> looking for work opportunities. Contact them directly to offer employment or discuss job opportunities.
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Search for workers available for hire in Gweru</CardDescription>
          </CardHeader>
          <CardContent>
